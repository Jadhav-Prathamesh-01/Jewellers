    ...
    <div className="pt-10 transition-opacity duration-500 ease-in border-t-2 opacity-100">
      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 px-6 py-6 text-sm text-gray-500 border">
          <p>
            An Baba Jewellery website is an online platform that facilitates the
            buying and selling of Jewellery or services over the internet. It
            serves as a virtual marketplace where businesses and individuals can
            showcase their Jewellery, interact with customers, and conduct
            transactions without the need for a physical presence. Baba Jewellery
            websites have gained immense popularity due to their convenience,
            accessibility, and global reach they offer.
          </p>
          <p>
           Baba Jewellery website typically display Jewellery or services along with
            detailed descriptions, images, prices, and any available variations
            (e.g., Texture, pattern, etc.). Each Jewellery usually its own dedicated
